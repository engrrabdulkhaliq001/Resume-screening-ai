...
html { background: #050914 !important; }
html, body { background-color: #050914 !important; min-height: 100vh; }
...
.hamburger {
    ...
    border-radius: 10px; cursor: pointer; padding: 8px; transition: background 0.2s;
...
.hamburger span {
    ...
    border-radius: 2px; transition: all 0.3s ease; transform-origin: center; pointer-events: none;
}

.mobile-menu {
    display: none; position: fixed;
    top: 60px; left: 0; right: 0; z-index: 999998;
    background: rgba(5,9,20,0.97); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px);
    border-bottom: 1px solid rgba(255,255,255,0.08);
    flex-direction: column; padding: 0.75rem 1rem; gap: 0.25rem;
    box-shadow: 0 8px 32px rgba(0,0,0,0.5); animation: slideDown 0.25s ease;
}
#menuToggle:checked + .mobile-menu { display: flex !important; }
.mobile-menu a {
    font-family: var(--font-d); font-weight: 600; font-size: 0.95rem;
    color: rgba(255,255,255,0.75) !important; padding: 0.85rem 1rem; border-radius: 10px;
    text-decoration: none !important; transition: background 0.2s, color 0.2s;
    border: 1px solid transparent; display: block;
}
.mobile-menu a:hover { background: rgba(255,255,255,0.08); color: #ffffff !important; }
.mobile-menu a.active { background: rgba(59,130,246,0.15); border-color: rgba(59,130,246,0.3); color: #93c5fd !important; }
...
.hero-section { position: relative; padding: 80px 0 60px; text-align: center; overflow: hidden; }
.hero-bg-grid {
...
.hero-badge {
    ...
    letter-spacing: 0.08em; margin-bottom: 24px; animation: fadeUp 0.6s ease both;
}
.hero-heading {
    font-family: var(--font-d); font-weight: 800;
    font-size: clamp(1.8rem, 4vw, 3rem); line-height: 1.1; letter-spacing: -0.02em;
    color: var(--text-hi); margin-bottom: 20px; animation: fadeUp 0.7s 0.1s ease both;
}
.gradient-text {
    background: linear-gradient(135deg, #60a5fa 0%, #a78bfa 50%, #67e8f9 100%);
    -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;
}
.hero-sub { color: #ffffff; font-size: 1.05rem; font-weight: 300; margin-bottom: 28px; animation: fadeUp 0.7s 0.2s ease both; }
.api-pill { display: inline-flex; align-items: center; gap: 8px; padding: 8px 18px; border-radius: 50px; font-size: 0.85rem; animation: fadeUp 0.7s 0.3s ease both; }
...
.stat-card {
    ...
    border-radius: var(--r-xl); backdrop-filter: blur(12px); overflow: visible; transition: var(--tr);
}
...
.glass-card {
    ...
    overflow: visible; transition: var(--tr); margin-bottom: 8px;
}
...
label {
    display: block !important; font-size: 0.8rem !important; font-weight: 700 !important;
    color: #ffffff !important; margin-bottom: 8px !important; letter-spacing: 0.04em !important;
    text-transform: uppercase !important; font-family: var(--font-d) !important;
...
.stNumberInput > div > div > input {
    ...
    padding: 12px 16px !important; font-family: var(--font-b) !important; font-size: 0.9rem !important;
    caret-color: #ffffff !important; outline: none !important;
}
.stTextInput > div > div > input:focus,
.stTextArea  > div > div > textarea:focus,
.stNumberInput > div > div > input:focus {
    border-color: rgba(59,130,246,0.5) !important; background: #000000 !important;
    box-shadow: 0 0 0 3px rgba(59,130,246,0.15) !important; caret-color: #ffffff !important;
}
...
.stButton > button[kind="primary"] {
    ...
    color: white !important; box-shadow: 0 4px 20px rgba(59,130,246,0.35) !important;
}
.stButton > button[kind="primary"]:hover {
    box-shadow: 0 8px 30px rgba(59,130,246,0.55) !important; filter: brightness(1.06) !important;
}
.stButton > button[kind="secondary"] {
    background: rgba(239,68,68,0.10) !important; border: 1px solid rgba(239,68,68,0.25) !important; color: #fca5a5 !important;
}
.stButton > button[kind="secondary"]:hover {
    background: rgba(239,68,68,0.18) !important; border-color: rgba(239,68,68,0.4) !important;
}

.stFileUploader > div {
    background: rgba(255,255,255,0.02) !important; border: 2px dashed var(--border) !important;
    border-radius: var(--r-lg) !important; transition: var(--tr) !important;
}
.stFileUploader > div:hover { border-color: rgba(59,130,246,0.5) !important; background: rgba(59,130,246,0.05) !important; }
...
button[data-testid="stBaseButton-secondary"][aria-label=""] {
    ...
    border: 1.5px solid rgba(255,255,255,0.3) !important; border-radius: 10px !important;
    padding: 0.5rem 1.4rem !important; font-weight: 600 !important; font-size: 0.88rem !important;
    cursor: pointer !important; box-shadow: 0 2px 14px rgba(0,0,0,0.6) !important;
    width: auto !important; transition: background 0.25s, border-color 0.25s, box-shadow 0.25s !important;
}
[data-testid="stFileUploaderDropzone"] button:hover,
.stFileUploader button:hover,
button[data-testid="stBaseButton-secondary"][aria-label=""]:hover {
    background: #1a1a2e !important; border-color: rgba(99,102,241,0.8) !important;
    box-shadow: 0 4px 22px rgba(99,102,241,0.45) !important; color: #ffffff !important;
}
...
@media (max-width: 768px) {
    .block-container { padding: 65px 0.85rem 2.5rem !important; }
    .navbar { padding: 0 1rem; height: 56px; }
    .nav-brand-text { font-size: 1rem; }
    .nav-links { display: none !important; }
    .hamburger { display: flex !important; }
    .mobile-menu { top: 56px; }
    .hero-section { padding: 50px 1rem 40px; }
    .hero-heading { font-size: clamp(1.6rem, 8vw, 2.2rem) !important; }
    .stats-row { grid-template-columns: 1fr !important; gap: 0.65rem !important; }
    ...
    .tl-item { flex-direction: column !important; gap: 12px !important; }
    .tech-grid { grid-template-columns: repeat(3,1fr) !important; }
    .rtable { font-size: 0.78rem !important; display: block !important; overflow-x: auto !important; }
}
...
@media (max-width: 480px) {
    ...
    .block-container { padding: 58px 0.65rem 2rem !important; }
...
def api_post(path, **kw):
    try:
        r = requests.post(f"{API_URL}{path}", timeout=60, **kw)
        return r.json()
...
def sbc(s):
    return "sb-hi" if s >= 75 else "sb-md" if s >= 50 else "sb-lo"
...
def lc(p):
    return "nav-link active" if page == p else "nav-link"
...
if page == "about":
    ...
    <div class="feat-grid">
        <div class="feat-card"><div class="feat-icon">🔍</div><div class="feat-title">Semantic Search</div><div class="feat-desc">Deep contextual understanding beyond keyword matching — LLaMA 3 understands intent, context, and skill equivalence.</div></div>
        <div class="feat-card"><div class="feat-icon">🧠</div><div class="feat-title">Vector Embeddings</div><div class="feat-desc">ChromaDB persistent vector store with SentenceTransformer embeddings — resumes indexed once, searched forever.</div></div>
        ...
        <div class="feat-card"><div class="feat-icon">🎯</div><div class="feat-title">Cross-Encoder Reranking</div><div class="feat-desc">FlashRank re-orders top candidates by reading JD and resume together — eliminates semantic drift.</div></div>
        <div class="feat-card"><div class="feat-icon">🔀</div><div class="feat-title">Hybrid Search</div><div class="feat-desc">Vector similarity + metadata hard filters — experience years and skill requirements enforced before LLM analysis.</div></div>
    </div>
    ...
    <div style="display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:10px;padding-bottom:2rem;">
        ...
        <span style="color:var(--text-lo);">·</span>
        <span style="font-family:var(--font-d);font-weight:700;font-size:.85rem;color:var(--text-mid);">🗄️ CHROMADB</span>
    </div>
...
if page == "hiw":
    ...
    <div class="div-line"></div>
    <div class="timeline">
        <div class="tl-item"><div class="tl-marker">01</div><div class="tl-card"><div class="tl-ico">📋</div><div class="tl-title">Upload Job Description</div><div class="tl-desc">Define the role with title, description, required skills, experience, and education level.</div></div></div>
        <div class="tl-item"><div class="tl-marker">02</div><div class="tl-card"><div class="tl-ico">📂</div><div class="tl-title">Upload Resumes</div><div class="tl-desc">Upload resumes in PDF, DOCX, DOC, or TXT format. Indexed into ChromaDB — never re-process again.</div></div></div>
        <div class="tl-item"><div class="tl-marker">03</div><div class="tl-card"><div class="tl-ico">🔀</div><div class="tl-title">Query Transformation</div><div class="tl-desc">Groq expands the JD into a rich semantic concept — synonyms, related tools, seniority signals.</div></div></div>
        <div class="tl-item"><div class="tl-marker">04</div><div class="tl-card"><div class="tl-ico">🔍</div><div class="tl-title">Hybrid Vector Search</div><div class="tl-desc">ChromaDB finds top 20 candidates using vector similarity + metadata hard filters.</div></div></div>
        <div class="tl-item"><div class="tl-marker">05</div><div class="tl-card"><div class="tl-ico">🎯</div><div class="tl-title">Cross-Encoder Reranking</div><div class="tl-desc">FlashRank re-reads JD + resume together to precisely reorder top 5 candidates.</div></div></div>
        <div class="tl-item"><div class="tl-marker">06</div><div class="tl-card"><div class="tl-ico">⚡</div><div class="tl-title">Groq LLM Final Analysis</div><div class="tl-desc">LLaMA 3 deeply scores only top 5 — matched skills, missing skills, score, recommendation.</div></div></div>
    </div>
    <div class="div-line"></div>
    ...
    <div class="tech-grid">
        ...
        <div class="tech-card"><div class="tech-emoji">🗄️</div><div class="tech-name">ChromaDB</div></div>
        <div class="tech-card"><div class="tech-emoji">🧠</div><div class="tech-name">SentenceTransformers</div></div>
        <div class="tech-card"><div class="tech-emoji">🎯</div><div class="tech-name">FlashRank</div></div>
...
#  HOME
# ═══════════════════════════════════════════════════════
resumes_n  = api_data.get("resumes_indexed", 0)   # ← fixed key
...
<div class="stats-row">
    <div class="stat-card">
        ...
        <div><div class="stat-value">{resumes_n}</div><div class="stat-label">Resumes Indexed</div></div>
    </div>
    <div class="stat-card">
        <div class="stat-icon">💼</div>
        ...
        <div class="card-hdr">
            <div class="sec-row">
                ...
                <div>
                    ...
                    <div class="sec-sub" style="color:#ffffff;opacity:0.8;">Step 2 — Indexed into ChromaDB permanently ⚡</div>
                </div>
            </div>
            <div class="card-div"></div>
        </div>
...
with cc:
    if st.button("🗑️ Clear", type="secondary", key="btn_clear"):
        try:
            requests.delete(f"{API_URL}/clear", timeout=5)
        except:
            pass
...
if score_btn:
    ...
    # Handle errors
    if not data:
        st.error("❌ No response from backend. Is the server running?")
    elif data.get("detail"):
        st.warning(f"⚠️ {data['detail']}")
    elif data.get("ranked_candidates") is not None:
        # ── SUCCESS — save to session state, NO st.rerun() here ──
        st.session_state["results"]     = data
        st.session_state["shortlisted"] = data.get("shortlisted", 0)
        # Show success message inline
        total = len(data.get("ranked_candidates", []))
        if total == 0:
            st.info("ℹ️ No candidates matched. Try uploading more resumes or relaxing the JD requirements.")
        else:
            st.success(f"✅ Ranked {total} candidate(s) successfully!")
    else:
...
if "results" in st.session_state:
    ...
    if not candidates:
        st.info("ℹ️ No candidates to display.")
    else:
        st.markdown("<br>", unsafe_allow_html=True)
        ...
        <div style="display:flex;gap:.5rem;flex-wrap:wrap;margin-bottom:1.25rem;">
            <span class="badge b-blue">Analyzed: {total_shown}</span>
            ...
            <span class="badge b-blue">Total Indexed: {data.get('total_indexed',0)}</span>
        </div>
        """, unsafe_allow_html=True)

        f_opt    = st.radio("Filter:", ["All","SHORTLIST","MAYBE","REJECT"], horizontal=True, key="filt")
        filtered = candidates if f_opt == "All" else [c for c in candidates if c.get("recommendation") == f_opt]

        if not filtered:
            st.info(f"No candidates with status: {f_opt}")
        else:
            rows = ""
            ...
            st.markdown("<br>", unsafe_allow_html=True)
            st.markdown('<div style="font-family:var(--font-d);font-size:1.2rem;font-weight:700;color:var(--text-hi);margin-bottom:.75rem;">🔍 Detailed Breakdown</div>', unsafe_allow_html=True)
            ...
            for c in filtered:
                ...
                with st.expander(f"{emoji}  {c.get('candidate_name','Unknown')}  —  {score}/100  ({rec})"):
                    ...
                    if c.get("rerank_score") is not None:
                        st.caption(f"🎯 Rerank score: {c.get('rerank_score', 0):.4f}  |  Vector distance: {c.get('vector_distance', 0):.4f}")
                    ...
                    with cm:
                        ...
                        st.markdown(
                            " ".join(f'<span class="ch-m">{sk}</span>' for sk in matched)
                            if matched else "<span style='color:var(--text-lo)'>None</span>",
                            unsafe_allow_html=True
                        )
                    with cx:
                        ...
                        st.markdown(
                            " ".join(f'<span class="ch-x">{sk}</span>' for sk in missing)
                            if missing else "<span style='color:#4ade80'>None ✓</span>",
                            unsafe_allow_html=True
                        )